# WaterNet 训练配置
- 代码基础：Fork自 [Li-Chongyi/Water-Net_Code](https://github.com/Li-Chongyi/Water-Net_Code)
- 本项目Fork仓库地址：https://github.com/3220105783/Water-Net_Code
- 本地修改：仅适配自定义数据集路径和训练配置，核心逻辑未改动；；仅保留用于训练和测试 WaterNet 的文件和文件夹，移除其他无关代码、配置及文档

## 代码来源与引用
- 原项目地址：https://github.com/Li-Chongyi/Water-Net_Code
